...
class Logger
{
    public:
        ...
        static void MatchLog(OrderBookType orderType, std::string product, long double price, std::string amount, std::string timestamp, long double longterm_EMA, long double shortterm_EMA);
